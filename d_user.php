...
background-repeat:no-repeat;background-size:100% 100%'>";
	...
	if(mysql_num_rows($res) == 0){
		...
		echo "<center><b><u><font face='gabriola' color='#5E8185' size='4'>USERS</font></u></b>:<br><br>";
		echo "<table border=2 style='color:#416064;font-family:gabriola'>";
		echo "<tr><th>Username</th><th>Password</th><th>First Name</th><th>Last Name</th><th>Date of Birth<th>Gender</th><th>Mobile Number</th><th>Email Address</th></tr>";
