...
background-repeat:no-repeat;background-size:100% 100%'>";
	...
	if(mysql_num_rows($res) == 0){
		...
		echo "<center><b><u><font face='gabriola' color='#5E8185' size='4'>TRAIN BOOKINGS</font></u></b>:<br><br>";
		echo "<table border=2 style='color:#416064;font-family:gabriola'>";
		echo "<tr><th>PNR</th><th>Username</th><th>Train No.</th><th>Train Name</th><th>Source<th>Destination</th><th>Departure Time</th><th>Arrival Time</th><th>No of Seats Booked</th><th>Total Fare</th></tr>";
