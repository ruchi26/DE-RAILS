<html>
<p style="font-size:180%;font-family:gabriola;color:#5E8185"><b><u>CREATE PROFILE</u></p>
<script type="text/javascript" src="reg.js" ></script>
<form name="form1" id ="form1" method="POST" action="registerc.php" onsubmit="return validForm()">
